...
For More Code Explanations

Here I explain all about it and you also check how to input a new student and search and update its record using the command line interface. If you have any query, comment it out !
